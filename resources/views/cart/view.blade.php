...
@section('contenido')
    <div class="relative flex flex-col min-h-screen font-inter bg-gray-100">
        ...
        <div class="flex-1 flex items-start justify-center p-4">
            <div class=" p-8 md:p-12 w-full max-w-sm sm:max-w-md">
                <h1 class="text-xl font-bold text-gray-900 text-center mb-4">
                    Cesta
                </h1>
                <div class="space-y-4">
                    @if($cartItems->isEmpty())
                        <p class="text-gray-500 text-center">Tu cesta está vacía.</p>
                    @else
                            ...
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg shadow-sm">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600">Precio: ${{ number_format($item->product->price, 2) }}</p>
                                    </div>
                                </div>
                ...
                <div class="fixed bottom-0 left-0 w-full bg-white shadow-inner border-t border-gray-300 z-50">
                    <div class="flex justify-around p-2">
                        <a href="{{ route('tienda') }}" class="flex flex-col items-center text-sm text-gray-700 hover:text-blue-600">
                        ...
                        <a href="{{ route('cart.view') }}"
                            ...
                            <svg width="30px" height="30px" viewBox="0 0 1024 1024" fill="#000000" class="icon"
                                version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="6.144">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path
