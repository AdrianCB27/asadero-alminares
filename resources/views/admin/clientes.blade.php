    ...
    <div class="relative flex flex-col h-screen font-inter bg-neutral-200">
        <div class="flex-1 flex items-start justify-center p-4 h-screen">
            <div class="bg-neutral-100 p-8 md:p-12 rounded-2xl shadow-xl w-full max-w-sm sm:max-w-md flex flex-col">
                ...
                <div class="flex-1 overflow-y-auto text-gray-700 bg-white shadow-md rounded-xl bg-clip-border mb-12">
        ...
        <div class="fixed bottom-0 left-0 w-full bg-white shadow-inner border-t border-gray-300 z-50">
            <div class="flex justify-around p-2">
                ...
                <a href="{{ route('productos.index') }} " class="flex flex-col items-center text-sm text-gray-700 hover:text-blue-600">
